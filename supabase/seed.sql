...
insert into categories (id, slug, nombre, descripcion, icono, color, orden) values
  ('2b4d3d87-f316-56b0-b338-0c3ac87fdf39', 'combos', 'Combos', 'Varias plataformas en un solo pago, al mejor precio.', 'layers', '#ff2fd0', 1),
  ('78154892-e853-5231-9714-7e3e4f66c996', 'streaming', 'Streaming', 'Películas y series bajo demanda.', 'clapperboard', '#a855f7', 2),
...
insert into services (id, category_id, slug, nombre, descripcion_corta, descripcion, logo_url, color, destacado, activo, orden) values
  ...
  ('9168d390-f53d-5c69-b08b-29fba73c62e0', '2b4d3d87-f316-56b0-b338-0c3ac87fdf39', 'combo-netflix-prime-disney', 'Netflix + Prime + Disney+', 'Tres plataformas, un solo pago.', 'Perfil propio en Netflix, Prime Video y Disney+. El combo más completo para toda la familia.', '/logos/combo-netflix-prime-disney.png', '#0f2fa5', true, true, 3),
  ('fc726882-9cee-5865-9317-ed11cba1e3a2', '2b4d3d87-f316-56b0-b338-0c3ac87fdf39', 'combo-netflix-prime-max', 'Netflix + Prime + Max', 'Cine, series y estrenos sin límite.', 'Perfil propio en Netflix, Prime Video y Max.', '/logos/combo-netflix-prime-max.png', '#6d28d9', false, true, 4),
  ('b0862a77-83af-5ad7-852e-c2146fc7234b', '2b4d3d87-f316-56b0-b338-0c3ac87fdf39', 'combo-netflix-prime-spotify', 'Netflix + Prime + Spotify', 'Entretenimiento completo: video y música.', 'Perfil propio en Netflix y Prime Video, más Spotify Premium.', '/logos/combo-netflix-prime-spotify.png', '#1db954', false, true, 5),
  ('6a2ce6eb-df48-529b-be41-22249bc593eb', '78154892-e853-5231-9714-7e3e4f66c996', 'netflix', 'Netflix', 'Series, películas y originales en HD/4K.', 'Acceso a todo el catálogo de Netflix con calidad HD o 4K según el plan. Entrega inmediata, garantía durante toda la vigencia y soporte por WhatsApp.', '/logos/netflix.png', '#e50914', true, true, 6),
  ('165da644-34c2-5724-a1a7-78610dde3be0', '78154892-e853-5231-9714-7e3e4f66c996', 'disney-plus', 'Disney+', 'Disney, Pixar, Marvel, Star Wars y ESPN.', 'Todo el universo Disney en un solo lugar, incluyendo Star y ESPN en el plan premium.', '/logos/disney-plus.png', '#0f2fa5', true, true, 7),
  ('32d051b5-b2a5-5713-9bf6-0b12cd23ab80', '78154892-e853-5231-9714-7e3e4f66c996', 'max', 'Max (HBO)', 'HBO, DC, Warner y los estrenos del año.', 'El catálogo completo de Max con series originales de HBO, cine de Warner y contenido DC.', '/logos/max.png', '#7c3aed', true, true, 8),
  ('b4ef416d-40d2-5ac3-bb36-43502dfb70c4', '78154892-e853-5231-9714-7e3e4f66c996', 'prime-video', 'Prime Video', 'Cine, series y producciones originales de Amazon.', 'Prime Video con acceso a estrenos, series originales y contenido exclusivo de Amazon.', '/logos/prime-video.png', '#00a8e1', true, true, 9),
  ('70fa438e-807e-54ed-9bd0-47d24c902fca', '78154892-e853-5231-9714-7e3e4f66c996', 'paramount-plus', 'Paramount+', 'Cine, series y contenido exclusivo de Paramount.', 'Paramount+ con su catálogo completo de películas y series originales.', '/logos/paramount-plus.png', '#0064ff', false, true, 10),
  ('cbdf399f-3d42-5c46-b5d2-92a35c4d0cbd', '78154892-e853-5231-9714-7e3e4f66c996', 'crunchyroll', 'Crunchyroll', 'El catálogo de anime más grande, con simulcast.', 'Anime sin anuncios, episodios el mismo día de su estreno en Japón y biblioteca completa.', '/logos/crunchyroll.png', '#f47521', false, true, 11),
  ('fd1d6756-633b-568c-8887-c894f766bcd9', '78154892-e853-5231-9714-7e3e4f66c996', 'vix', 'Vix', 'Cine y series en español, novelas y fútbol.', 'Vix Premium con contenido en español, novelas, cine mexicano y deportes.', '/logos/vix.png', '#ff4d4d', false, true, 12),
  ('242f5fb3-59db-5707-9efb-ce34f5338e7e', '78154892-e853-5231-9714-7e3e4f66c996', 'plex', 'Plex', 'Tu biblioteca de películas y series en un solo lugar.', 'Plex Premium con acceso a bibliotecas y contenido gratuito con soporte.', '/logos/plex.png', '#e5a00d', false, true, 13),
  ('5191432a-e8b0-5282-8e96-3b3c4076a61f', '78154892-e853-5231-9714-7e3e4f66c996', 'iptv', 'IPTV', 'Canales en vivo, nacionales e internacionales.', 'Servicio de televisión por internet con canales nacionales, internacionales y deportes.', '/logos/iptv.png', '#38bdf8', false, true, 14),
  ('af53a9b5-5718-5ef7-9f88-5785be0389b3', '78154892-e853-5231-9714-7e3e4f66c996', 'jellyfin', 'Jellyfin', 'Servidor de streaming privado con gran catálogo.', 'Acceso a un servidor Jellyfin con biblioteca de películas y series.', '/logos/jellyfin.png', '#a855f7', false, true, 15),
  ('181df90f-bb63-50e7-bec1-ce441063b27b', '78154892-e853-5231-9714-7e3e4f66c996', 'viki-rakuten', 'Viki Rakuten', 'Doramas coreanos, chinos y japoneses.', 'Rakuten Viki con doramas y series asiáticas subtituladas, sin anuncios.', '/logos/viki-rakuten.png', '#00b0f0', false, true, 16),
  ('261c4478-e59c-5394-9d84-fcc47e8b36d4', '78154892-e853-5231-9714-7e3e4f66c996', 'flujo-tv', 'Flujo TV', 'Canales en vivo y contenido bajo demanda.', 'Plataforma de televisión en línea con canales en vivo y catálogo bajo demanda.', '/logos/flujo-tv.png', '#22d3ee', false, true, 17),
  ('56b8d724-1566-54bc-b97b-c1c75a66e884', '78154892-e853-5231-9714-7e3e4f66c996', 'telelatino', 'Telelatino + WIN', 'Canales latinos con WIN Sports incluido.', 'Telelatino con canales en español y WIN Sports+ para el fútbol colombiano.', '/logos/telelatino.png', '#f59e0b', false, true, 18),
  ('6ed3c7f8-4696-52a8-9e86-bdf4f81c32bf', '78154892-e853-5231-9714-7e3e4f66c996', 'youtube-premium', 'YouTube Premium', 'YouTube sin anuncios, con descargas y música.', 'YouTube Premium: video sin anuncios, reproducción en segundo plano, descargas y YouTube Music.', '/logos/youtube-premium.png', '#ff0000', false, true, 19),
  ...
  ('985e8418-2ee8-5d46-8f67-46d790f63577', '4066e7e3-b9dd-5955-b0e2-f4d5c6b8d366', 'ps-plus', 'PlayStation Plus Deluxe', 'Catálogo de juegos para PS4 y PS5.', 'PS Plus Deluxe con catálogo de juegos, clásicos y multijugador en línea.', '/logos/ps-plus.svg', '#0070d1', false, true, 30),
  ...
  ('0577f8f4-e82f-57c8-9420-0dd4c6e71a8d', 'd8fa66ad-4c6a-5163-a33d-260d437793ca', 'mcafee', 'McAfee Antivirus', 'Protección completa para tus dispositivos.', 'McAfee Antivirus por un año con protección en tiempo real y navegación segura.', '/logos/mcafee.svg', '#c01818', false, true, 32)
