...
--
-- Precio de venta = costo del proveedor más barato + $2.000
-- ============================================================================
...
insert into service_plans (id, service_id, nombre, descripcion, duracion_dias, precio_venta, pantallas, disponible, activo, orden) values
  ('764f3db0-bf4a-56dc-8cf1-68889ecc0c28', '6a2ce6eb-df48-529b-be41-22249bc593eb', 'Premium · 1 pantalla', 'Perfil propio en HD/4K', 30, 14000, 1, true, true, 1),
  ('71efb27d-3fdc-52ae-a99c-2a13dcd73aa6', '6a2ce6eb-df48-529b-be41-22249bc593eb', 'Cuenta completa', '5 perfiles, control total de la cuenta', 30, 39000, 5, true, true, 2),
  ('5f0fbd1e-a0f2-5d94-be50-d41e2206bf95', '165da644-34c2-5724-a1a7-78610dde3be0', 'Estándar · 1 pantalla', 'Perfil propio, catálogo básico', 30, 8000, 1, true, true, 1),
  ('b78cb344-aa79-56d8-bd8b-217b487cec06', '165da644-34c2-5724-a1a7-78610dde3be0', 'Premium con ESPN · 1 pantalla', 'Perfil propio con deportes incluidos', 30, 11000, 1, true, true, 2),
  ('a3132c40-a66c-5004-823e-f973c168f7cc', '165da644-34c2-5724-a1a7-78610dde3be0', 'Cuenta completa Premium', '7 perfiles, control total', 30, 35000, 7, true, true, 3),
  ('0e724583-fe29-562d-8974-531b983cb503', '32d051b5-b2a5-5713-9bf6-0b12cd23ab80', 'Estándar · 1 pantalla', 'Perfil propio sin anuncios', 30, 7000, 1, true, true, 1),
  ('6c3818c3-632a-576a-acb8-257372aaa72b', 'b4ef416d-40d2-5ac3-bb36-43502dfb70c4', 'Estándar · 1 pantalla', 'Perfil propio', 30, 7000, 1, true, true, 1),
  ('94b9ef57-9995-59a2-84e7-707b0b3f4cc6', 'b4ef416d-40d2-5ac3-bb36-43502dfb70c4', 'Cuenta completa', 'Control total de la cuenta', 30, 20000, 6, true, true, 2),
  ('f5d77b06-5613-50cd-9db7-11e9c61b3a03', '70fa438e-807e-54ed-9bd0-47d24c902fca', 'Estándar · 1 pantalla', 'Perfil propio', 30, 7000, 1, true, true, 1),
  ('f5e68862-4d27-5c02-ac2f-babdd070ac99', 'cbdf399f-3d42-5c46-b5d2-92a35c4d0cbd', 'Mega Fan · 1 pantalla', 'Anime sin anuncios', 30, 7000, 1, true, true, 1),
  ('34a204ef-4e42-565b-b7f0-98a78070f4fa', 'fd1d6756-633b-568c-8887-c894f766bcd9', 'Estándar · 1 pantalla', 'Perfil propio', 30, 6000, 1, true, true, 1),
  ('f30b1f6a-5553-5fc7-bc1f-fd267ea4272d', '242f5fb3-59db-5707-9efb-ce34f5338e7e', 'Pantalla', 'Un dispositivo', 30, 7000, 1, true, true, 1),
  ('c7557d89-0332-558a-be4c-496d919c9b33', '242f5fb3-59db-5707-9efb-ce34f5338e7e', 'Premium · 3 dispositivos', 'Hasta 3 dispositivos', 30, 17000, 3, true, true, 2),
  ('de76190a-54b5-51a4-b140-3aba964b20e6', '5191432a-e8b0-5282-8e96-3b3c4076a61f', 'Estándar', 'Canales en vivo', 30, 7000, 1, true, true, 1),
  ('e92223c5-9cba-50a8-9682-991a015282a9', '5191432a-e8b0-5282-8e96-3b3c4076a61f', 'IPTV + WIN Sports', 'Incluye WIN Sports+', 30, 12000, 1, true, true, 2),
  ('7bdabfc8-7fe7-5023-b748-4263091e7f97', 'af53a9b5-5718-5ef7-9f88-5785be0389b3', 'Acceso mensual', 'Un usuario', 30, 17000, 1, true, true, 1),
  ('fddae8b5-cab4-5f17-803a-e0145ee1571e', '181df90f-bb63-50e7-bec1-ce441063b27b', 'Estándar · 1 pantalla', 'Perfil propio', 30, 11000, 1, true, true, 1),
  ('7d4fc099-a8bd-5a22-8891-236b7d3ffe07', '261c4478-e59c-5394-9d84-fcc47e8b36d4', 'Pantalla', 'Un dispositivo', 30, 12000, 1, true, true, 1),
  ('d99fc50b-4494-5773-8a81-fa57475760bf', '261c4478-e59c-5394-9d84-fcc47e8b36d4', 'Cuenta completa', 'Varios dispositivos', 30, 20000, 4, true, true, 2),
  ('7f8e1ad0-246e-5ce4-9436-8701ee4b5535', '56b8d724-1566-54bc-b97b-c1c75a66e884', 'Mensual', 'Canales latinos + WIN', 30, 17000, 1, true, true, 1),
  ('82a5887a-bbe9-55b9-a639-c619e46dd80e', '6ed3c7f8-4696-52a8-9e86-bdf4f81c32bf', 'Premium · 1 mes', 'Cuenta propia', 30, 9000, 1, true, true, 1),
  ('c32317ca-5117-5d74-a714-15a9b02cf175', 'c42d28a8-be84-5cee-9dca-da85927e93b5', 'Combo · 1 pantalla c/u', 'Un perfil en cada plataforma', 30, 21000, 1, true, true, 1),
  ('29f08eb2-4485-55b5-b724-879d77a6c68e', '59426ef0-7dfd-5781-bbab-5c6b9d5eb592', 'Combo · 1 pantalla c/u', 'Un perfil en cada plataforma', 30, 18000, 1, true, true, 1),
  ('367e0489-9e32-5d06-a82d-1916adb3ccc1', '9168d390-f53d-5c69-b08b-29fba73c62e0', 'Combo · 1 pantalla c/u', 'Un perfil en cada plataforma', 30, 31000, 1, true, true, 1),
  ('05c78f34-082e-5c8e-bf2d-9049fd1bcbf2', 'fc726882-9cee-5865-9317-ed11cba1e3a2', 'Combo · 1 pantalla c/u', 'Un perfil en cada plataforma', 30, 28000, 1, true, true, 1),
  ('27ff1fb7-56e2-5735-8d1a-586aa73fdf07', 'b0862a77-83af-5ad7-852e-c2146fc7234b', 'Combo · 1 pantalla c/u', 'Video y música incluidos', 30, 29000, 1, true, true, 1),
  ('c154da2a-b06d-5d55-96c9-a289c4bf4bc5', '4103d0e5-da21-522d-9fe2-b01e7c711f2d', 'Mensual', 'Deportes en vivo', 30, 10000, 1, true, true, 1),
  ('0a766734-0845-538f-99e5-f5088be80981', 'cdb7ba23-c1fb-5bc3-a1a4-eecd7467ec96', 'Plan Oro · mensual', 'Sin WIN Sports', 30, 22000, 1, true, true, 1),
  ('e6cef54e-9177-565f-a862-5e7882a6474c', 'f2813b7c-c914-514e-b234-1a73e89305e4', 'Premium · 1 mes', 'Cuenta propia renovable', 30, 10000, 1, true, true, 1),
  ('ac119ce0-7a53-5611-85f7-8bcd0718b948', 'f2813b7c-c914-514e-b234-1a73e89305e4', 'Premium · 3 meses', 'Ahorra pagando por trimestre', 90, 24000, 1, true, true, 2),
  ('b8cd729f-5873-5b8b-8806-2f4d266761d1', '27bab71b-e0b9-53e8-8b7a-e90636637097', 'Premium · 1 mes', 'Consultar disponibilidad', 30, 5000, 1, true, true, 1),
  ('3219211d-e7de-516d-92c3-df2a28f5bfeb', '0cfd6eeb-fdf4-50e6-a691-86b8247909fb', 'Business Pro · 1 mes', 'Cuenta con acceso completo', 30, 25000, 1, true, true, 1),
  ('ab665406-9ead-5837-9408-cfe0c9e789df', '51f6e43d-baaf-58c7-a268-2d761fecbf9c', 'Pro · 1 mes', 'Cuenta con acceso completo', 30, 12000, 1, true, true, 1),
  ('72608056-ab6a-5454-bfab-5bbacf24a19f', '56d294a9-7e0f-5812-9dcc-c92f83e269c4', 'Pro · 1 mes', 'Cuenta con acceso completo', 30, 22000, 1, true, true, 1),
  ('4fc06b25-fc03-5f9e-a978-197f8fa8cdef', 'ef29bf9c-4925-5dae-98ed-0a4206b5ec1b', 'Pro · 1 mes', 'Correo personal', 30, 7000, 1, true, true, 1),
  ('2f1401fa-e115-5217-b08e-7275b3583d3c', 'ef29bf9c-4925-5dae-98ed-0a4206b5ec1b', 'Pro · 6 meses', 'Correo personal', 180, 27000, 1, true, true, 2),
  ('9fd6c7f2-5df1-56a2-96fa-2c7993ead4f2', 'ef29bf9c-4925-5dae-98ed-0a4206b5ec1b', 'Pro · 1 año', 'Correo personal', 365, 40000, 1, true, true, 3),
  ('20fc4610-81cc-5a1d-97ca-6cbf32799551', '869cd590-171f-538d-8335-d910fdb15885', 'Pro · 1 mes', 'Cuenta con acceso completo', 30, 20000, 1, true, true, 1),
  ('8d9b3c42-3e69-5fa5-9b63-4be09ae9dff9', '303ed1e7-6cf3-5cb3-b346-354b01850c3d', 'Mensual', 'Consola y PC', 30, 47000, 1, true, true, 1),
  ('744c1a4b-b408-5474-bfb6-da70f11acca1', '985e8418-2ee8-5d46-8f67-46d790f63577', 'Mensual · PS4/PS5', 'Cuenta con acceso completo', 30, 78000, 1, true, true, 1),
  ('51906623-ea49-5305-80f2-5a696e389f7c', '80a96cc9-b585-5e59-8992-326f78b8c674', '1 año · compartida', 'Licencia compartida', 365, 72000, 1, true, true, 1),
  ('780afeea-6ce9-52a2-89f0-4136fa11d398', '80a96cc9-b585-5e59-8992-326f78b8c674', '1 año · correo personal', 'Licencia en tu propio correo', 365, 173000, 1, true, true, 2),
  ('19ebfc86-aa7d-5b89-bf31-7433ffecfd4c', '0577f8f4-e82f-57c8-9420-0dd4c6e71a8d', '1 año', 'Licencia anual', 365, 69000, 1, true, true, 1)
