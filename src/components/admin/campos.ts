...
export function camposCuenta(
  ...
  return [
    ...
    { name: 'costo_adquisicion', label: 'Costo', tipo: 'numero', prefijo: '$', requerido: true, valor: a?.costo_adquisicion ?? '', ayuda: 'Lo que te cobró el proveedor. El precio de venta se define en cada venta.' },
